                ...
                Padding(
                  ...
                  child: RichText(
                    text: new TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(text: 'Hello', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 30, color: theme.primaryColor)),
                        TextSpan(text: 'World', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: theme.primaryColor)),
                      ],
                    ),
                  ),
                ),
